...
}`)}function Es(t){t.uniforms.add(new te("screenSizePerspectiveAlignment",e=>Ms(e.screenSizePerspectiveAlignment||e.screenSizePerspective)))}function Ms(t){return oe(Rs,t.parameters.divisor,t.parameters.offset,t.parameters.minPixelSize,t.paddingPixelsOverride)}const Rs=Ut();function ui(t,e){const r=t.vertex;e.hasVerticalOffset?(Ps(r),e.hasScreenSizePerspective&&(t.include(Os),Es(r),gt(t.vertex,e)),r.code.add(s`
...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=ea(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return gr({colorWrite:xr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-63b8f375.js"),["assets/SSAOBlur.glsl-63b8f375.js","assets/index-7963d4d4.js","assets/index-530e9757.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-48134b4b.js","assets/vec32-4751fa25.js","assets/DefaultMaterial_COLOR_GAMMA-6039fe63.js","assets/DictionaryLoader-3032dcef.js","assets/LRUCache-50962364.js","assets/FieldsIndex-86e1c691.js","assets/quat-8f88fd04.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-a659aa24.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-21dccbe4.js","assets/InterleavedLayout-0945ebc5.js","assets/types-1305598a.js","assets/vec4f64-aa64c7e9.js","assets/sphere-9e6a7002.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-c69e1ac8.js","assets/Texture-e38be9d6.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-450b7cb8.js","assets/lengthUtils-3299f41f.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-ebe38004.js"]));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),t}function Ti(t){return Math.max(10,20*t.computeScreenPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const co=_o(),rl=Object.freeze(Object.defineProperty({__proto__:null,build:tl,getRadius:Ti},Symbol.toStringTag,{value:"Module"}));let ol=class _i extends yr{initializeProgram(e){return new Cr(e.rctx,_i.shader.get().build(),Gt)}initializePipeline(){return gr({colorWrite:xr})}};ol.shader=new Wt(rl,()=>xt(()=>import("./SSAO.glsl-a537e682.js"),["assets/SSAO.glsl-a537e682.js","assets/index-7963d4d4.js","assets/index-530e9757.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/vec4f64-aa64c7e9.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-48134b4b.js","assets/vec32-4751fa25.js","assets/DefaultMaterial_COLOR_GAMMA-6039fe63.js","assets/DictionaryLoader-3032dcef.js","assets/LRUCache-50962364.js","assets/FieldsIndex-86e1c691.js","assets/quat-8f88fd04.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-a659aa24.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-21dccbe4.js","assets/InterleavedLayout-0945ebc5.js","assets/types-1305598a.js","assets/sphere-9e6a7002.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-c69e1ac8.js","assets/Texture-e38be9d6.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-450b7cb8.js","assets/lengthUtils-3299f41f.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-ebe38004.js"]));const il=2;function Er(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(o,i)=>i.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/il),r.code.add(s`float evaluateAmbientOcclusionInverse() {
